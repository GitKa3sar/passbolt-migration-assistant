...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Passbolt Migration Assistant - v0.25.0"
...
function Invoke-ConfirmedImport {
    ...
    try {
        ...
        [System.Windows.MessageBox]::Show($FailureMessage, "Importazione non completata - v0.25.0", "OK", "Error") | Out-Null
    } finally {
        foreach ($Entry in $SecretOverrides) { $Entry.password = $null }
...
if ($SelfTest) {
    ...
    if (
        $Window.Title -notmatch "v0\.25\.0" -or
