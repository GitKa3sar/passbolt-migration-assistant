...
- Mantieni il progetto fail-closed, limitato a Passbolt v4 e classificato come beta tecnica finché i gate esterni non sono completi.
...
- Non usare credenziali o dati reali. Test e laboratori automatici devono restare sintetici e confinati a `127.0.0.1`; la matrice reale richiede autorizzazioni separate e non fa parte del gate offline.
